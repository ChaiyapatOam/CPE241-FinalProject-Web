    ...
    <>
      <div className="flex flex-row">
        ...
        <div className="basis-4/5 flex flex-col items-center mr-10">
          <div className="flex flex-row justify-evenly w-8/12 mb-2">
            <div className="flex flex-row">
          ...
          <div className="bg-white w-7/12 rounded-xl drop-shadow-xl my-5 ">
            <div className="grid grid-cols-3 items-center">
              <div className="col-span-2 rounded-l-xl flex flex-col pl-3 py-3 gap-1">
                ...
                <div className="flex flex-row">
                  <h1 className="font-semibold">Guest : 01232</h1>{" "}
              ...
              <div className="col-span-1  bg-primary-blue rounded-r-xl py-3 pr-3 h-full text-right ">
                <div className="text-white mt-1 mb-3">
                  <h1 className="font-medium ">Check in date :&nbsp;</h1>{" "}
                  <h1>13/02/2023</h1>
                </div>
                <div className="text-white">
                  <h1 className="font-medium">Check out date &nbsp;</h1>{" "}
                  <h1>13/02/2023</h1>
                </div>
              </div>
            </div>
