    ...
    <div className="flex flex-row">
       ...
       <div className="grid grid-cols-2">
            <div className="col-span-1 grid">
                <div className="col-span-1 grid">
                <h1 className="text-dark-grey text-xl underline underline-offset-8 decoration-primary-blue m-5 mb-8">Check Avaliable Room</h1>
                <Form.Item
                    label="Check in date"
                    name="checkInDate"
                ...
                <Button
                    ...
                    size="large"> See avaliable room
                </Button>
                </div>
                <h1 className="text-dark-grey text-xl underline underline-offset-8 decoration-primary-blue m-5 mb-8">Avaliable Rooms</h1>
                    <div>
            ...
            <div className="col-span-1 grid">
                <h1 className="text-dark-grey text-xl underline underline-offset-8 decoration-primary-blue m-5 mb-8">Reservation</h1>
                <Form.Item
                    label="Phone number"
                    name="phoneNumber"
                    rules={[{ required: true, message: "Please input Phone number!" }]} >
